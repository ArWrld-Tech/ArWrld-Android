package com.eth.zeroxmap.fragment.foam;
...
public class FoamVisionMapFragment extends BaseFragment {
    ...
    private final FoamVisionMapFragment.ArMapFragmentLocationCallback callback = new FoamVisionMapFragment.ArMapFragmentLocationCallback(this);
...
//                    Utils.displayError(this, "Unable to load renderables", ex);
    ...
    private static class ArMapFragmentLocationCallback implements LocationEngineCallback<LocationEngineResult> {
        ...
        private final WeakReference<FoamVisionMapFragment> activityWeakReference;

        ArMapFragmentLocationCallback(FoamVisionMapFragment activity) {
            this.activityWeakReference = new WeakReference<>(activity);
        }

        @Override
        public void onSuccess(LocationEngineResult result) {
            FoamVisionMapFragment activity = activityWeakReference.get();
            if (activity != null) {
